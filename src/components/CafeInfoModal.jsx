                        ...
                        <Dialog.Panel className={'relative mx-auto w-full max-w-md bg-white rounded-xl'}>
                            <div className="px-10 py-10 shadow-sm w-full">
                                ...
                                <Dialog.Description className={'text-lg mb-5'}>
                                    لوکیو، پلتفرمی است که به شما امکان ‌ضبط و نشر داستان‌ها، گفتگوها و حتی صداهای محیط اطرافتان را می‌دهد. اینجا مکانی است که شما می‌توانید داستان‌های خود را به اشتراک بگذارید و همچنین داستان‌‌های دیگران را به روایت خودشان گوش‌ کنید.<br />
                                </Dialog.Description>
